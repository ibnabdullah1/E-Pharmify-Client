        ...
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          ...
          <div className="mt-4">
            <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
              <Link
                href="/"
                className="text-white cursor-pointer hover:text-teal-500"
              >
                <svg
                  fill="currentColor"
                  strokeLinecap="round"
              ...
              <Link
                href="/"
                className="ml-3 text-white cursor-pointer hover:text-teal-500"
              >
                <svg
                  fill="currentColor"
                  strokeLinecap="round"
      ...
      <div className="bg-secondary border-t">
        <div className="container px-5 py-4 mx-auto">
          <p className="text-sm text-gray-200 capitalize xl:text-center">
            ...
            <span className="text-primary">Pharmify.com</span>
          </p>
        </div>
      </div>
    </footer>
